...
public class Digital_clock extends JFrame{
    ...
    public Digital_clock(){
        ...
        dateLabel.setHorizontalAlignment(SwingConstants.NORTH_EAST);
        dateLabel.setVerticalAlignment(SwingConstants.CENTER);
        dateLabel.setForeground(Color.WHITE);

        //Adding the date and time labels to the panel
    ...
    private void updateTimeAndDate(){
        //first of all we need to take the time and Format it
        Calendar calendar=Calendar.getInstance();
        SimpleDateFormat timeFormatter=new SimpleDateFormat("HH:mm:ss");
        String time=timeFormatter.format(calendar.getTime());

        //get the current date and format it
        SimpleDateFormat dateFormatter=new SimpleDateFormat("EEEEEE,MM/dd/yyyy");
